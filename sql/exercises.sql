...
SELECT payment_id, amount, payment_date FROM payment WHERE payment_date BETWEEN '2005-05-27' AND curdate();
...
SELECT * FROM category WHERE category_id>4 AND name REGEXP '^[CST]';
...
LEFT JOIN city ON staff.address_id = city.city_id;
